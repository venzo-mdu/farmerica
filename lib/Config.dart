class Config {
  static String key = "ck_eedc4b30808be5c1110691e5b29f16280ebd3b72";
  ...
  static String addtoCartUrl = "add-to-cart";
  static String cartUrl = "+cart";
  static String userId = "52";
